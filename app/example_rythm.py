...
audio = './app/JUDGEMENT-審判_(Vocals).wav'
ref = './app/karaoke_performance.wav'
...
rhythm_deviation = np.subtract(np.mean(np.abs(beat_frames)), np.mean(np.abs(ref_beat_frames)))
